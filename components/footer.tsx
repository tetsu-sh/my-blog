...
const sns=[
  ...
  label: 'Github',},{href: 'https://twitter.com/tetsu04228',
...
<div className="vstack items-center gap-4">
          <div className="flex gap-4">
            {sns.map(({ href, icon, label }) => (
              <Link key={href} href={href} className="text-neutral-200 hover:text-neutral-500 active:text-gray-600 transition duration-100">
